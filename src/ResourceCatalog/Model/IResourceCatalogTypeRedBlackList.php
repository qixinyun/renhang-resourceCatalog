...
interface IResourceCatalogTypeRedBlackList
{
    const TYPE_RED_BLACK_LIST = array(
        ...
        IResourceCatalog::TYPE['JDLKPKHGRSNDKFFQD'] => ISearchableResourceCatalogData::RED_BLACK_LIST['NULL'],
        IResourceCatalog::TYPE['JDLKPKHRKXX'] => ISearchableResourceCatalogData::RED_BLACK_LIST['NULL'],
    );
}
